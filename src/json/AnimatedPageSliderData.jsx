...
const AnimatedPageSliderData = {
  en: [
    {
      id: 0,
      name: "1 Atmosphere Meets Excellence",
      tag: "Join us and experience it for yourself",
      url: "../assets/images/lir_relaxed_pub_garden.webp",
      desc: [
    ...
    {
      id: 1,
      name: "2 Hidden in the Heart of the City",
      tag: "Experience the 'Craic' in One of Berlin's Best",
      url: "../assets/images/lir_welcome.webp",
      desc: [
    ...
    {
      id: 2,
      name: "3 Welcome to Lir - Your Perfect Night Out",
      tag: "Visit us today and experience the magic of The Lir",
      url: "../assets/images/lir_bar_warm_glow.webp",
      desc: [
    ...
    {
      id: 3,
      name: "4 Experience the Magic of Lir",
      tag: "Join us today and let the good times flow!",
      url: "../assets/images/lir_outside_warm.webp",
      desc: [
    ...
    {
      id: 4,
      name: "5 Game On at The Lir",
      tag: "Don't just watch the game - feel the energy.",
      url: "../assets/images/lir_outside_sports.webp",
      desc: [
