      ...
      <div className="px-4 mx-auto max-w-screen-2xl md:px-8">
        <section className="flex flex-col justify-between gap-6 mb-8 sm:gap-10 md:mb-16 md:gap-16 lg:flex-row">
          ...
          <div className="flex flex-col justify-center sm:text-center lg:py-12 lg:text-left xl:w-5/12">
            <p className="mb-4 font-semibold text-primaryGreen md:mb-6 md:text-lg xl:text-xl">
              In the heart of Dahme-Heideseen
            </p>
            ...
            <div className="flex flex-col gap-2.5 sm:flex-row sm:justify-center lg:justify-start">
              <a
                href="#"
                className="inline-block px-8 py-3 text-sm font-semibold text-center text-white transition duration-100 rounded-lg outline-none bg-primaryGreen ring-primaryGreenDark hover:bg-primaryGreenLight focus-visible:ring active:bg-primaryGreenDark md:text-base"
              >
                Start now
              </a>
              ...
              <a
                href="#"
                className="inline-block px-8 py-3 text-sm font-semibold text-center text-gray-500 transition duration-100 bg-gray-200 rounded-lg outline-none ring-primaryGreenDark hover:bg-primaryGreenDark hover:text-white focus-visible:ring active:text-primaryGreenDark md:text-base"
              >
                Take tour
              </a>
            </div>
          ...
          <div className="h-56 overflow-hidden bg-gray-100 rounded-lg shadow-lg lg:h-96 xl:w-7/12">
            <img
              src="../assets/images/forest_wedding.webp"
              loading="lazy"
